...
class PagesAPI {
  ...
  async account (req, res) {
    ...
    var userRecord = await this.cloud.usersDB.getByID(session.id)
    var hashbaseAccount = await this.hashbase.accountsDB.getByID(session.id)
    res.render('account', {userRecord, hashbaseAccount, ucfirst, pluralize})
  }
  ...
  async accountUpgrade (req, res) {
    ...
    var userRecord = await this.cloud.usersDB.getByID(session.id)
    res.render('account-upgrade', {userRecord})
  }
}
